...
void process_newchannel_request (RequestChannel *_channel){
	...
	if (ipcmethod == "f") {
        data_channel = new FIFORequestChannel (new_channel_name, FIFORequestChannel::SERVER_SIDE);
    }
    else if (ipcmethod == "q") {
        data_channel = new MQRequestChannel (new_channel_name, MQRequestChannel::SERVER_SIDE, buffercapacity);
    }
    else if (ipcmethod == "m") {
		data_channel = new SHMRequestChannel (new_channel_name, SHMRequestChannel::SERVER_SIDE, buffercapacity);
